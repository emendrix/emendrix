...
Measured on **2026-09-05** at revision `6097989`, from [`reports/eval/2026-09-05-6097989.md`](./reports/eval/2026-09-05-6097989.md). The deterministic rows cover every transition in the committed corpus (18 of 18 scored); the model rows cover the pinned explanation subset only, because each change in it is one recorded call to a provider.
